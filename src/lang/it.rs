...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connessione alla rete Heko Remotesupport..."),
        ...
        ("install_tip", "A causa del controllo account uUtente (UAC), Heko Remotesupport potrebbe non funzionare correttamente come desktop remoto.\nPer evitare questo problema, fai clic sul tasto qui sotto per installare Heko Remotesupport a livello di sistema."),
        ("Click to upgrade", "Aggiorna"),
        ("Click to download", "Download"),
        ("Click to update", "Aggiorna"),
        ("Configure", "Configura"),
        ("config_acc", "Per controllare il desktop dall'esterno, devi fornire a Heko Remotesupport il permesso 'Accessibilità'."),
        ("config_screen", "Per controllare il desktop dall'esterno, devi fornire a Heko Remotesupport il permesso 'Registrazione schermo'."),
        ...
        ("android_input_permission_tip1", "Affinché un dispositivo remoto possa controllare un dispositivo Android tramite mouse o tocco, devi consentire a Heko Remotesupport di usare il servizio 'Accessibilità'."),
        ("android_input_permission_tip2", "Vai nella pagina delle impostazioni di sistema che si aprirà di seguito, trova e accedi a [Servizi installati], attiva il servizio [Heko Remotesupport Input]."),
        ...
        ("Language", "Lingua"),
        ("Keep Heko Remotesupport background service", "Mantieni il servizio di Heko Remotesupport in background"),
        ("Ignore Battery Optimizations", "Ignora le ottimizzazioni della batteria"),
        ("android_open_battery_optimizations_tip", "Se vuoi disabilitare questa funzione, vai nelle impostazioni dell'applicazione Heko Remotesupport, apri la sezione 'Batteria' e deseleziona 'Senza restrizioni'."),
        ...
        ("Show Heko Remotesupport", "Visualizza Heko Remotesupport"),
        ("This PC", "Questo PC"),
        ("or", "O"),
        ...
        ("config_input", "Per controllare il desktop remoto con la tastiera, è necessario concedere le autorizzazioni a Heko Remotesupport 'Monitoraggio input'."),
        ("config_microphone", "Per poter chiamare, è necessario concedere l'autorizzazione a Heko Remotesupport 'Registra audio'."),
        ...
        ("still_click_uac_tip", "Richiedi ancora che l'utente remoto faccia clic su OK nella finestra UAC dell'esecuzione di Heko Remotesupport."),
        ...
        ("install_cert_tip", "Installa certificato Heko Remotesupport"),
        ("confirm_install_cert_tip", "Questo è un certificato di test Heko Remotesupport, che può essere considerato attendibile.\nIl certificato verrà usato per certificarsi ed installare i driver Heko Remotesupport quando richiesto."),
        ...
        ("verify_rustdesk_password_tip", "Conferma password Heko Remotesupport"),
        ...
        ("Exit", "Esci da Heko Remotesupport"),
        ("Open", "Apri Heko Remotesupport"),
