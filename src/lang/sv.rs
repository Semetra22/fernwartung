...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Ansluter till Heko Remotesupport..."),
        ...
        ("install_tip", "På grund av UAC, kan inte Heko Remotesupport fungera ordentligt på klientsidan. För att undvika UAC, tryck på knappen nedan för att installera Heko Remotesupport på systemet."),
        ...
        ("config_acc", "För att kontrollera din dator på distans måste du ge Heko Remotesupport \"Tillgänglighets\" rättigheter."),
        ("config_screen", "För att kontrollera din dator på distans måste du ge Heko Remotesupport \"Skärminspelnings\" rättigheter."),
        ...
        ("android_input_permission_tip2", "Gå till systeminställningarna, hitta [Installed Services], sätt på [Heko Remotesupport Input] tjänsten."),
        ...
        ("Language", "Språk"),
        ("Keep Heko Remotesupport background service", "Behåll Heko Remotesupport i bakgrunden"),
        ("Ignore Battery Optimizations", "Ignorera batterioptimering"),
        ("android_open_battery_optimizations_tip", "Om du vill stänga av denna funktion, gå till nästa Heko Remotesupport programs inställningar, hitta [Batteri], Checka ur [Obegränsad]"),
        ("Start on Boot", ""),
        ...
        ("Show Heko Remotesupport", "Visa Heko Remotesupport"),
        ("This PC", "Denna dator"),
        ("or", "eller"),
