...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "Prêt"),
        ("Established", "Établi"),
        ("connecting_status", "Connexion au réseau Heko Remotesupport..."),
        ...
        ("config_acc", "Afin de pouvoir contrôler votre bureau à distance, veuillez donner l'autorisation \"accessibilité\" à Heko Remotesupport."),
        ("config_screen", "Afin de pouvoir accéder à votre bureau à distance, veuillez donner à Heko Remotesupport l'autorisation \"enregistrement d'écran\"."),
        ...
        ("android_input_permission_tip1", "Pour qu'un appareil distant puisse contrôler votre appareil Android via la souris ou le toucher, vous devez autoriser Heko Remotesupport à utiliser le service \"Accessibilité\"."),
        ("android_input_permission_tip2", "Veuillez accéder à la page suivante des paramètres système, recherchez et entrez [Services installés], activez le service [Heko Remotesupport Input]."),
        ...
        ("Language", "Langue"),
        ("Keep Heko Remotesupport background service", "Gardez le service Heko Remotesupport en arrière plan"),
        ...
        ("Show Heko Remotesupport", "Afficher Heko Remotesupport"),
        ("This PC", "Ce PC"),
        ("or", "ou"),
        ...
        ("config_input", "Afin de contrôler le bureau à distance avec le clavier, vous devez accorder à Heko Remotesupport l'autorisation \"Surveillance de l’entrée\"."),
        ("config_microphone", "Pour discuter à distance, vous devez accorder à Heko Remotesupport les autorisations « Enregistrer l'audio »."),
        ...
        ("still_click_uac_tip", "Nécessite toujours que l'utilisateur distant confirme par la fenêtre UAC de Heko Remotesupport en cours d'éxécution."),
        ...
        ("install_cert_tip", "Installer le certificat Heko Remotesupport"),
        ("confirm_install_cert_tip", "Il s'agit d'un certificat Heko Remotesupport, auquel on peut faire confiance. Le certificat sera utilisé pour approuver et installer les pilotes Heko Remotesupport si nécessaire."),
        ...
        ("verify_rustdesk_password_tip", "Vérifier le mot de passe Heko Remotesupport"),
