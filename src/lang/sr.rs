...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Spajanje na Heko Remotesupport mrežu..."),
        ...
        ("install_tip", "Zbog UAC Heko Remotesupport ne može raditi pravilno u nekim slučajevima. Da biste prevazišli UAC, kliknite taster ispod da instalirate Heko Remotesupport na sistem."),
        ...
        ("config_acc", "Da biste daljinski kontrolisali radnu površinu, Heko Remotesupport-u treba da dodelite \"Accessibility\" prava."),
        ("config_screen", "Da biste daljinski pristupili radnoj površini, Heko Remotesupport-u treba da dodelite \"Screen Recording\" prava."),
        ...
        ("android_input_permission_tip1", "Da bi daljinski uređaj kontrolisao vaš Android uređaj preko miša ili na dodir, treba da dozvolite Heko Remotesupport-u da koristi \"Accessibility\" servis."),
        ("android_input_permission_tip2", "Molimo pređite na sledeću stranicu sistemskih podešavanja, pronađite i unesite [Installed Services], uključite [Heko Remotesupport Input] servis."),
        ...
        ("Language", "Jezik"),
        ("Keep Heko Remotesupport background service", "Zadrži Heko Remotesupport kao pozadinski servis"),
        ("Ignore Battery Optimizations", "Zanemari optimizacije baterije"),
        ("android_open_battery_optimizations_tip", "Ako želite da onemogućite ovu funkciju, molimo idite na sledeću stranicu za podešavanje Heko Remotesupport aplikacije, pronađite i uđite u [Battery], isključite [Unrestricted]"),
        ("Start on Boot", ""),
        ...
        ("Show Heko Remotesupport", "Prikazi Heko Remotesupport"),
        ("This PC", "Ovaj PC"),
        ("or", "ili"),
