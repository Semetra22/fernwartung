...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Подключение к сети Heko Remotesupport..."),
        ...
        ("install_tip", "В некоторых случаях из-за UAC Heko Remotesupport может работать неправильно на удалённом узле. Чтобы избежать UAC, нажмите кнопку ниже для установки Heko Remotesupport в системе."),
        ...
        ("Configure", "Настроить"),
        ("config_acc", "Чтобы удалённо управлять своим рабочим столом, вы должны предоставить Heko Remotesupport права \"доступа\""),
        ("config_screen", "Для удалённого доступа к рабочему столу вы должны предоставить Heko Remotesupport права \"снимок экрана\""),
        ...
        ("android_input_permission_tip1", "Чтобы удалённое устройство могло управлять вашим Android-устройством с помощью мыши или нажатий, необходимо разрешить Heko Remotesupport использовать службу \"Специальные возможности\"."),
        ("android_input_permission_tip2", "Перейдите на соответствующую страницу системных настроек, найдите и войдите в \"Установленные службы\", включите службу \"Heko Remotesupport Input\"."),
        ...
        ("Language", "Язык"),
        ("Keep Heko Remotesupport background service", "Держать в фоне службу Heko Remotesupport"),
        ...
        ("Show Heko Remotesupport", "Показать Heko Remotesupport"),
        ...
        ("config_input", "Чтобы управлять удалённым рабочим столом с помощью клавиатуры, необходимо предоставить Heko Remotesupport разрешения \"Мониторинг ввода\"."),
        ("config_microphone", "Чтобы разговаривать с удалённой стороной, необходимо предоставить Heko Remotesupport разрешение \"Запись аудио\"."),
        ...
        ("still_click_uac_tip", "По-прежнему требуется, чтобы удалённый пользователь нажал \"OK\" в окне UAC при запуске Heko Remotesupport."),
        ...
        ("install_cert_tip", "Установить сертификат Heko Remotesupport"),
        ("confirm_install_cert_tip", "Это тестовый сертификат Heko Remotesupport, которому можно доверять. Он будет использоваться только по необходимости для установки драйверов Heko Remotesupport."),
        ...
        ("verify_rustdesk_password_tip", "Подтвердить пароль Heko Remotesupport"),
