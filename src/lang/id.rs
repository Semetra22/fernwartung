...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Menghubungkan ke jaringan Heko Remotesupport..."),
        ...
        ("install_tip", "Karena UAC, Heko Remotesupport tidak dapat bekerja dengan baik sebagai sisi remote dalam beberapa kasus. Untuk menghindari UAC, silakan klik tombol di bawah ini untuk menginstal Heko Remotesupport ke sistem."),
        ("Click to upgrade", "Klik untuk upgrade"),
        ("Click to download", "Klik untuk unduh"),
        ("Click to update", "Klik untuk memperbarui"),
        ("Configure", "Konfigurasi"),
        ("config_acc", "Untuk mengontrol Desktop Anda dari jarak jauh, Anda perlu memberikan izin \"Aksesibilitas\" Heko Remotesupport."),
        ("config_screen", "Untuk mengakses Desktop Anda dari jarak jauh, Anda perlu memberikan izin \"Perekaman Layar\" Heko Remotesupport."),
        ...
        ("android_input_permission_tip1", "Agar perangkat jarak jauh dapat mengontrol perangkat Android Anda melalui mouse atau sentuhan, Anda harus mengizinkan Heko Remotesupport untuk menggunakan layanan \"Aksesibilitas\"."),
        ("android_input_permission_tip2", "Silakan buka halaman pengaturan sistem berikutnya, temukan dan masuk ke [Layanan Terinstal], aktifkan layanan [Input Heko Remotesupport]."),
        ...
        ("Language", "Bahasa"),
        ("Keep Heko Remotesupport background service", "Pertahankan Heko Remotesupport berjalan pada service background"),
        ...
        ("Show Heko Remotesupport", "Tampilkan Heko Remotesupport"),
        ("This PC", "PC ini"),
        ("or", "atau"),
        ...
        ("config_input", "Untuk menggunakan input keyboard remote, anda perlu memberikan izin \"Pemantauan Input\" pada Heko Remotesupport"),
        ("config_microphone", "Untuk berbicara secara remote, anda perlu memberikan izin \"Rekam Audio\" pada Heko Remotesupport"),
        ...
        ("still_click_uac_tip", "Masih memerlukan persetujuan pihak pengguna remote untuk mengklik OK pada jendela UAC Heko Remotesupport yang sedang berjalan"),
        ...
        ("install_cert_tip", "Install sertifikat Heko Remotesupport"),
        ("confirm_install_cert_tip", "Ini adalah sertifikat pengujian Heko Remotesupport, yang dapat dipercaya. Sertifikat ini akan digunakan untuk menginstal driver Heko Remotesupport saat diperlukan"),
        ...
        ("verify_rustdesk_password_tip", "Verifikasi Kata Sandi Heko Remotesupport"),
