...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "준비"),
        ("Established", "연결됨"),
        ("connecting_status", "Heko Remotesupport 네트워크로 연결중입니다..."),
        ...
        ("OS Password", "OS 비밀번호"),
        ("install_tip", "UAC로 인해, Heko Remotesupport가 원격지일 때 일부 기능이 동작하지 않을 수 있습니다. UAC 문제를 방지하려면, 아래 버튼을 클릭하여 Heko Remotesupport를 시스템에 설치해주세요."),
        ("Click to upgrade", "클릭하여 업그레이드"),
        ("Click to download", "클릭하여 다운로드"),
        ("Click to update", "클릭하여 업데이트"),
        ("Configure", "구성"),
        ("config_acc", "당신의 데스크탑을 원격으로 제어하기 전에, Heko Remotesupport에게 \"Accessibility (접근성)\" 권한을 부여해야 합니다."),
        ("config_screen", "당신의 데스크탑을 원격으로 제어하기 전에, Heko Remotesupport에게 \"Screen Recording (화면 녹화)\" 권한을 부여해야 합니다."),
        ("Installing ...", "설치중 ..."),
        ("Install", "설치하기"),
        ("Installation", "설치"),
        ...
        ("android_input_permission_tip1", "원격지로서 마우스나 터치를 통해 Android 장치를 제어하려면 Heko Remotesupport에서 \"Accessibility (접근성)\" 서비스 사용을 허용해야 합니다."),
        ("android_input_permission_tip2", "시스템 설정 페이지로 이동하여 [설치된 서비스]에서 [Heko Remotesupport Input] 서비스를 켜십시오."),
        ...
        ("Language", "언어"),
        ("Keep Heko Remotesupport background service", "Heko Remotesupport 백그라운드 서비스로 유지하기"),
        ("Ignore Battery Optimizations", "배터리 최적화 무시하기"),
        ("android_open_battery_optimizations_tip", "해당 기능을 비활성화하려면 Heko Remotesupport 응용 프로그램 설정 페이지로 이동하여 [배터리]에서 [제한 없음] 선택을 해제하십시오."),
        ("Start on Boot", ""),
