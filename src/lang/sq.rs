...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Për shkak të UAC, Rustdesk nuk mund të punoj sic duhet si nje remote në distancë në disa raste. Për të shamngur UAC, ju lutem klikoni butonin më poshtë për të instaluar Heko Remotesupport në sistem."),
        ("Click to upgrade", "Klikoni për përmirësim"),
        ("Click to download", "Klikoni për tu shkarkuar"),
        ("Click to update", "Klikoni për përditësim"),
        ("Configure", "Koniguro"),
        ("config_acc", "Për të kontrolluar Desktopin tuaj nga distanca, duhet të jepni leje Heko Remotesupport \"Aksesueshmëri\"."),
        ("config_screen", "Për të aksesuar Desktopin tuaj nga distanca, duhet ti jepni lejet Heko Remotesupport \"Regjistrimin e ekranit\"."),
        ...
        ("android_input_permission_tip1", "Në mënyrë që një pajisje në distancë të kontrollojë pajisjen tuaj Android nëpërmjet mausit ose prekjes, duhet të lejoni Heko Remotesupport të përdorë shërbimin."),
        ("android_input_permission_tip2", "Ju lutemi shkoni në faqen tjetër të cilësimeve të sistemit, gjeni dhe shtypni [Shërbimet e Instaluara], aktivizoni shërbimin [Heko Remotesupport Input]"),
        ...
        ("Language", "Gjuha"),
        ("Keep Heko Remotesupport background service", "Mbaje shërbimin e sfondit të Heko Remotesupport"),
        ("Ignore Battery Optimizations", "Injoro optimizimet e baterisë"),
        ("android_open_battery_optimizations_tip", "Nëse dëshironi ta çaktivizoni këtë veçori, ju lutemi shkoni te faqja tjetër e cilësimeve të aplikacionit Heko Remotesupport, gjeni dhe shtypni [Batteri], hiqni zgjedhjen [Te pakufizuara]"),
        ("Start on Boot", ""),
        ...
        ("Show Heko Remotesupport", "Shfaq Heko Remotesupport"),
        ("This PC", "Ky PC"),
        ("or", "ose"),
