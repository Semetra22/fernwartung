...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Verbinden mit dem Heko Remotesupport-Netzwerk …"),
        ...
        ("install_tip", "Aufgrund der Benutzerkontensteuerung (UAC) kann Heko Remotesupport in manchen Fällen nicht ordnungsgemäß funktionieren. Um die Benutzerkontensteuerung zu umgehen, klicken Sie bitte auf die Schaltfläche unten und installieren Heko Remotesupport auf dem System."),
        ("Click to upgrade", "Upgrade"),
        ("Click to download", "Zum Herunterladen klicken"),
        ("Click to update", "Update"),
        ("Configure", "Konfigurieren"),
        ("config_acc", "Um Ihren PC aus der Ferne zu steuern, müssen Sie Heko Remotesupport Zugriffsrechte erteilen."),
        ("config_screen", "Um aus der Ferne auf Ihren PC zugreifen zu können, müssen Sie Heko Remotesupport die Berechtigung \"Bildschirmaufnahme\" erteilen."),
        ...
        ("android_input_permission_tip1", "Damit ein entferntes Gerät Ihr Android-Gerät steuern kann, müssen Sie Heko Remotesupport erlauben, den Dienst \"Barrierefreiheit\" zu verwenden."),
        ("android_input_permission_tip2", "Bitte gehen Sie zur nächsten Systemeinstellungsseite, suchen Sie \"Installierte Dienste\" und schalten Sie den Dienst \"Heko Remotesupport Input\" ein."),
        ...
        ("Language", "Sprache"),
        ("Keep Heko Remotesupport background service", "Heko Remotesupport im Hintergrund ausführen"),
        ...
        ("Show Heko Remotesupport", "Heko Remotesupport anzeigen"),
        ("This PC", "Dieser PC"),
        ("or", "oder"),
        ...
        ("config_input", "Um den entfernten Desktop mit der Tastatur steuern zu können, müssen Sie Heko Remotesupport die Berechtigung \"Eingabeüberwachung\" erteilen."),
        ("config_microphone", "Um aus der Ferne sprechen zu können, müssen Sie Heko Remotesupport die Berechtigung \"Audio aufzeichnen\" erteilen."),
        ...
        ("still_click_uac_tip", "Der entfernte Benutzer muss immer noch im UAC-Fenster von Heko Remotesupport auf \"Ja\" klicken."),
        ...
        ("install_cert_tip", "Heko Remotesupport-Zertifikat installieren"),
        ("confirm_install_cert_tip", "Dies ist ein Heko Remotesupport-Testzertifikat, dem vertraut werden kann. Das Zertifikat wird verwendet, um Heko Remotesupport-Treibern bei Bedarf zu vertrauen und diese zu installieren."),
        ...
        ("verify_rustdesk_password_tip", "Heko Remotesupport-Passwort bestätigen"),
