...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "A ligar à rede do Heko Remotesupport..."),
        ...
        ("install_tip", "Devido ao UAC, o Heko Remotesupport não funciona correctamente em alguns casos. Para evitar o UAC, por favor clique no botão abaixo para instalar o Heko Remotesupport no sistema."),
        ...
        ("config_acc", "Para controlar o seu Ambiente de Trabalho remotamente, é preciso conceder ao Heko Remotesupport permissões de \"Acessibilidade\"."),
        ("config_screen", "Para aceder ao seu Ambiente de Trabalho remotamente, é preciso conceder ao Heko Remotesupport permissões de \"Gravar a Tela\"/"),
        ...
        ("android_input_permission_tip1", "Para que um dispositivo remoto controle o seu dispositivo Android via rato ou toque, você precisa permitir que o Heko Remotesupport use o serviço \"Acessibilidade\"."),
        ("android_input_permission_tip2", "Por favor vá para a próxima página de configuração do sistema, encontre e entre [Serviços Instalados], ACTIVE o serviço [Heko Remotesupport Input]."),
        ...
        ("Language", "Linguagem"),
        ("Keep Heko Remotesupport background service", "Manter o serviço Heko Remotesupport em funcionamento"),
