...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Heko Remotesupport może nie działać poprawnie na maszynie zdalnej z przyczyn związanych z UAC. W celu uniknięcia problemów z UAC, kliknij poniższy przycisk by zainstalować Heko Remotesupport w swoim systemie."),
        ...
        ("android_input_permission_tip1", "Aby można było sterować Twoim urządzeniem za pomocą myszy lub dotyku, musisz zezwolić Heko Remotesupport na korzystanie z usługi \"Ułatwienia dostępu\"."),
        ("android_input_permission_tip2", "Przejdź do następnej strony ustawień systemowych, znajdź i wejdź w [Zainstalowane usługi], włącz usługę [Heko Remotesupport Input]."),
        ...
        ("Language", "Język"),
        ("Keep Heko Remotesupport background service", "Zachowaj usługę Heko Remotesupport w tle"),
        ("Ignore Battery Optimizations", "Ignoruj optymalizację baterii"),
        ("android_open_battery_optimizations_tip", "Jeśli chcesz wyłączyć tę funkcję, przejdź do następnej strony ustawień aplikacji Heko Remotesupport, znajdź i wprowadź [Bateria], odznacz [Bez ograniczeń]"),
        ...
        ("Show Heko Remotesupport", "Pokaż Heko Remotesupport"),
        ...
        ("config_input", "By kontrolować zdalne urządzenie przy pomocy klawiatury, musisz udzielić aplikacji Heko Remotesupport uprawnień do \"Urządzeń Wejściowych\"."),
        ...
        ("install_cert_tip", "Instalacja certyfikatu Heko Remotesupport"),
        ("confirm_install_cert_tip", "To jest certyfikat testowy Heko Remotesupport, któremu można zaufać. Certyfikat jest używany do zaufania i instalowania sterowników Heko Remotesupport w razie potrzeby."),
        ...
        ("empty_lan_tip", "Ojej, wygląda na to, że nie odkryliśmy żadnych urządzeń z Heko Remotesupport w Twojej sieci."),
        ...
        ("verify_rustdesk_password_tip", "Weryfikuj hasło Heko Remotesupport"),
