...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Prisijungiama prie Heko Remotesupport tinklo..."),
        ...
        ("install_tip", "Kai kuriais atvejais UAC gali priversti Heko Remotesupport netinkamai veikti nuotoliniame pagrindiniame kompiuteryje. Norėdami apeiti UAC, spustelėkite toliau esantį mygtuką, kad įdiegtumėte Heko Remotesupport į savo kompiuterį."),
        ...
        ("config_acc", "Norėdami nuotoliniu būdu valdyti darbalaukį, turite suteikti Heko Remotesupport \"prieigos\" leidimus"),
        ("config_screen", "Norėdami nuotoliniu būdu pasiekti darbalaukį, turite suteikti Heko Remotesupport leidimus \"ekrano kopija\""),
        ("Installing ...", "Diegiama ..."),
        ("Install", "Diegti"),
        ...
        ("install_daemon_tip", "Norėdami, kad Heko Remotesupport startuotų automatiškai, turite ją įdiegti"),
        ...
        ("android_input_permission_tip1", "Kad nuotolinis įrenginys galėtų valdyti Android įrenginį pele arba liesti, turite leisti Heko Remotesupport naudoti \"Prieinamumo\" paslaugą."),
        ("android_input_permission_tip2", "Eikite į kitą sistemos nustatymų puslapį, suraskite \"Įdiegtos paslaugos\" ir įgalinkite \"Heko Remotesupport įvestis\" paslaugą."),
        ...
        ("Language", "Kalba"),
        ("Keep Heko Remotesupport background service", "Palikti Heko Remotesupport fonine paslauga"),
        ...
        ("Show Heko Remotesupport", "Rodyti Heko Remotesupport"),
        ...
        ("config_input", "Norėdami valdyti nuotolinį darbalaukį naudodami klaviatūrą, turite suteikti Heko Remotesupport leidimus \"Įvesties monitoringas\"."),
        ("config_microphone", "Norėdami kalbėtis su nuotoline puse, turite suteikti Heko Remotesupport leidimą \"Įrašyti garsą\"."),
        ...
        ("still_click_uac_tip", "Vis tiek reikia, kad nuotolinis vartotojas paleidžiant Heko Remotesupport UAC lange paspaustų \"OK\"."),
        ...
        ("verify_rustdesk_password_tip", "Įveskite kliento Heko Remotesupport slaptažodį"),
