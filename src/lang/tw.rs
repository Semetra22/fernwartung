...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "就緒"),
        ("Established", "已建立"),
        ("connecting_status", "正在連線到 Heko Remotesupport 網路 ..."),
        ("Enable Service", "啟用服務"),
        ("Start Service", "啟動服務"),
        ...
        ("Set Password", "設定密碼"),
        ("OS Password", "作業系統密碼"),
        ("install_tip", "UAC 會導致 Heko Remotesupport 在某些情況下無法正常作為遠端端點運作。若要避開 UAC，請點選下方按鈕將 Heko Remotesupport 安裝到系統中。"),
        ("Click to upgrade", "點選以升級"),
        ("Click to download", "點選以下載"),
        ("Click to update", "點選以更新"),
        ("Configure", "設定"),
        ("config_acc", "為了遠端控制您的桌面，您需要授予 Heko Remotesupport「協助工具」權限。"),
        ("config_screen", "為了遠端存取您的桌面，您需要授予 Heko Remotesupport「螢幕錄製」權限。"),
        ("Installing ...", "正在安裝 ..."),
        ("Install", "安裝"),
        ("Installation", "安裝"),
        ...
        ("android_input_permission_tip1", "為了讓遠端裝置能夠透過滑鼠或觸控控制您的 Android 裝置，您需要允許 Heko Remotesupport 使用「輔助功能」服務。"),
        ("android_input_permission_tip2", "請前往下一個系統設定頁面，找到並進入「已安裝的服務」，開啟「Heko Remotesupport Input」服務。"),
        ...
        ("Language", "語言"),
        ("Keep Heko Remotesupport background service", "保持 Heko Remotesupport 後台服務"),
        ("Ignore Battery Optimizations", "忽略電池最佳化"),
        ("android_open_battery_optimizations_tip", "如果您想要停用此功能，請前往下一個 Heko Remotesupport 應用程式設定頁面，找到並進入「電池」，取消勾選「不受限制」"),
        ("Start on Boot", "開機時啟動"),
        ...
        ("Show Heko Remotesupport", "顯示 Heko Remotesupport"),
        ("This PC", "此電腦"),
        ("or", "或"),
        ("Continue with", "繼續"),
        ("Elevate", "提升權限"),
        ...
        ("config_input", "為了能夠透過鍵盤控制遠端桌面，請給予 Heko Remotesupport \"輸入監控\" 權限。"),
        ("config_microphone", "為了支援透過麥克風進行音訊傳輸，請給予 Heko Remotesupport \"錄音\"權限。"),
        ...
        ("verify_rustdesk_password_tip", "驗證 Heko Remotesupport 密碼"),
