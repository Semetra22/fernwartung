...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Σύνδεση στο δίκτυο Heko Remotesupport..."),
        ...
        ("install_tip", "Λόγω UAC, το Heko Remotesupport ενδέχεται να μην λειτουργεί σωστά σε ορισμένες περιπτώσεις. Για να αποφύγετε το UAC, κάντε κλικ στο κουμπί παρακάτω για να εγκαταστήσετε το Heko Remotesupport στο σύστημα"),
        ("Click to upgrade", "Πιέστε για αναβάθμιση"),
        ("Click to download", "Πιέστε για λήψη"),
        ("Click to update", "Πιέστε για ενημέρωση"),
        ("Configure", "Διαμόρφωση"),
        ("config_acc", "Για τον απομακρυσμένο έλεγχο του υπολογιστή σας, πρέπει να εκχωρήσετε δικαιώματα πρόσβασης στο Heko Remotesupport."),
        ("config_screen", "Για να αποκτήσετε απομακρυσμένη πρόσβαση στον υπολογιστή σας, πρέπει να εκχωρήσετε το δικαίωμα Heko Remotesupport \"Screen Capture\"."),
        ...
        ("android_input_permission_tip1", "Για να μπορεί μία απομακρυσμένη συσκευή να ελέγχει τη συσκευή σας Android, πρέπει να επιτρέψετε στο Heko Remotesupport να χρησιμοποιεί την υπηρεσία \"Προσβασιμότητα\"."),
        ("android_input_permission_tip2", "Παρακαλώ μεταβείτε στην επόμενη σελίδα ρυθμίσεων συστήματος, βρείτε και πληκτρολογήστε [Εγκατεστημένες υπηρεσίες], ενεργοποιήστε την υπηρεσία [Είσοδος Heko Remotesupport]."),
        ...
        ("Language", "Γλώσσα"),
        ("Keep Heko Remotesupport background service", "Εκτέλεση του Heko Remotesupport στο παρασκήνιο"),
        ...
        ("Show Heko Remotesupport", "Εμφάνιση Heko Remotesupport"),
        ...
        ("config_input", "Για να ελέγξετε την απομακρυσμένη επιφάνεια εργασίας με πληκτρολόγιο, πρέπει να εκχωρήσετε δικαιώματα στο Heko Remotesupport"),
        ...
        ("still_click_uac_tip", "Εξακολουθεί να απαιτεί από τον απομακρυσμένο χρήστη να κάνει κλικ στο OK στο παράθυρο UAC όπου εκτελείται το Heko Remotesupport."),
