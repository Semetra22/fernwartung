...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "În curs de conectare la rețeaua Heko Remotesupport..."),
        ...
        ("install_tip", "Din cauza restricțiilor CCU, este posibil ca Heko Remotesupport să nu funcționeze corespunzător. Pentru a evita acest lucru, dă clic pe butonul de mai jos pentru a instala Heko Remotesupport."),
        ...
        ("config_acc", "Pentru a controla desktopul la distanță, trebuie să permiți Heko Remotesupport acces la setările de Accesibilitate."),
        ("config_screen", "Pentru a controla desktopul la distanță, trebuie să permiți Heko Remotesupport acces la setările de Înregistrare ecran."),
        ...
        ("android_input_permission_tip1", "Pentru ca un dispozitiv la distanță să poată controla un dispozitiv Android folosind mouse-ul sau suportul tactil, trebuie să permiți Heko Remotesupport să utilize serviciul „Accesibilitate”."),
        ("android_input_permission_tip2", "Accesează următoarea pagină din Setări, deschide [Aplicații instalate] și pornește serviciul [Heko Remotesupport Input]."),
        ...
        ("Language", "Limbă"),
        ("Keep Heko Remotesupport background service", "Rulează serviciul Heko Remotesupport în fundal"),
        ("Ignore Battery Optimizations", "Ignoră optimizările de baterie"),
        ("android_open_battery_optimizations_tip", "Pentru dezactivarea acestei funcții, accesează setările aplicației Heko Remotesupport, deschide secțiunea [Baterie] și deselectează [Fără restricții]."),
        ...
        ("Show Heko Remotesupport", "Afișează Heko Remotesupport"),
        ("This PC", "Acest PC"),
        ("or", "sau"),
        ...
        ("config_input", "Pentru a controla desktopul la distanță folosind tastatura, trebuie să acorzi Heko Remotesupport permisiunea Monitorizare intrare"),
        ("config_microphone", "Pentru a desfășura un apel vocal, este nevoie să acorzi Heko Remotesupport permisiunea Înregistrare audio."),
        ...
        ("still_click_uac_tip", "Este necesar ca utilizatorul la distanță să confirme în fereastra CCU din Heko Remotesupport care rulează."),
        ...
        ("install_cert_tip", "Instalează certificatul Heko Remotesupport"),
        ("confirm_install_cert_tip", "Acesta este un certificat de testare Heko Remotesupport și este de încredere. Certificatul va fi utilizat pentru a acorda încredere și instala drivere Heko Remotesupport atunci când este necesar."),
        ...
        ("verify_rustdesk_password_tip", "Verifică parola Heko Remotesupport"),
