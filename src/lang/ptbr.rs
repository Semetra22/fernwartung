...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conectando à rede do Heko Remotesupport..."),
        ...
        ("install_tip", "Devido ao UAC, o Heko Remotesupport não funciona corretamente como o lado remoto em alguns casos. Para evitar o UAC, por favor clique no botão abaixo para instalar o Heko Remotesupport no sistema."),
        ...
        ("config_acc", "Para controlar seu computador remotamente, você precisa conceder ao Heko Remotesupport permissões de \"Acessibilidade\"."),
        ("config_screen", "Para acessar seu computador remotamente, você precisa conceder ao Heko Remotesupport permissões de \"Gravar a Tela\"/"),
        ...
        ("android_input_permission_tip1", "Para que um dispositivo remoto controle seu dispositivo Android via mouse ou toque, você precisa permitir que o Heko Remotesupport use o serviço \"Acessibilidade\"."),
        ("android_input_permission_tip2", "Por favor vá para a próxima página de configuração do sistema, encontre e entre [Serviços Instalados], HABILITE o serviço [Heko Remotesupport Input]."),
        ...
        ("Language", "Idioma"),
        ("Keep Heko Remotesupport background service", "Manter o serviço do Heko Remotesupport executando em segundo plano"),
        ...
        ("Show Heko Remotesupport", "Exibir Heko Remotesupport"),
        ...
        ("config_input", "Para controlar a área de trabalho remota com teclado, você precisa conceder a permissão \"Monitoramento de entrada\" do Heko Remotesupport."),
        ("config_microphone", "Para falar remotamente, você precisa conceder a permissão \"Gravar áudio\" do Heko Remotesupport."),
        ...
        ("still_click_uac_tip", "Ainda requer que o usuário remoto clique em OK na janela UAC da execução do Heko Remotesupport."),
        ...
        ("verify_rustdesk_password_tip", "Verifique a senha do Heko Remotesupport"),
