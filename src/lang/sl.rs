...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Vzpostavljanje povezave z omrežjem Heko Remotesupport..."),
        ...
        ("install_tip", "Zaradi nadzora uporabniškega računa, Heko Remotesupport v nekaterih primerih na oddaljeni strani ne deluje pravilno. Temu se lahko izognete z namestitvijo."),
        ("Click to upgrade", "Klikni za nadgradnjo"),
        ("Click to download", "Klikni za prenos"),
        ("Click to update", "Klikni za posodobitev"),
        ("Configure", "Nastavi"),
        ("config_acc", "Za oddaljeni nadzor namizja morate Heko Remotesupportu dodeliti pravico za dostopnost"),
        ("config_screen", "Za oddaljeni dostop do namizja morate Heko Remotesupportu dodeliti pravico snemanje zaslona"),
        ...
        ("android_input_permission_tip1", "Za oddaljeni nadzor vaše naprave Android, je potrebno Heko Remotesupportu dodeliti pravico za dostopnost."),
        ("android_input_permission_tip2", "Pojdite v sistemske nastavitve, poiščite »Nameščene storitve« in vklopite storitev »Heko Remotesupport Input«."),
        ...
        ("Language", "Jezik"),
        ("Keep Heko Remotesupport background service", "Ohrani Heko Remotesupportovo storitev v ozadju"),
        ("Ignore Battery Optimizations", "Prezri optimizacije baterije"),
        ("android_open_battery_optimizations_tip", "Če želite izklopiti to možnost, pojdite v nastavitve aplikacije Heko Remotesupport, poiščite »Baterija« in izklopite »Neomejeno«"),
        ("Start on Boot", ""),
        ...
        ("Show Heko Remotesupport", "Prikaži Heko Remotesupport"),
