...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connexió a la xarxa Heko Remotesupport en progrés..."),
        ...
        ("android_input_permission_tip1", "Per a que un dispositiu remot controli el seu dispositiu Android amb el ratolí o tocs, cal permetre que Heko Remotesupport utilitzi el servei d' \"Accesibilitat\"."),
        ("android_input_permission_tip2", "Vagi a la pàgina de [Serveis instal·lats], activi el servici [Heko Remotesupport Input]."),
        ...
        ("Language", "Idioma"),
        ("Keep Heko Remotesupport background service", "Mantenir Heko Remotesupport com a servei en segon pla"),
