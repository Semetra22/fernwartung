...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conexión a la red Heko Remotesupport en progreso..."),
        ...
        ("install_tip", "Debido al Control de cuentas de usuario, es posible que Heko Remotesupport no funcione correctamente como escritorio remoto. Para evitar este problema, haga clic en el botón de abajo para instalar Heko Remotesupport a nivel de sistema."),
        ("Click to upgrade", "Clic para actualizar"),
        ("Click to download", "Clic para descargar"),
        ("Click to update", "Clic para refrescar"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar su escritorio desde el exterior, debe otorgar permiso a Heko Remotesupport de \"Accesibilidad\"."),
        ("config_screen", "Para controlar su escritorio desde el exterior, debe otorgar permiso a Heko Remotesupport de \"Grabación de pantalla\"."),
        ...
        ("android_input_permission_tip1", "Para que un dispositivo remoto controle su dispositivo Android a través del mouse o toque, debe permitir que Heko Remotesupport use el servicio de \"Accesibilidad\"."),
        ("android_input_permission_tip2", "Vaya a la página de configuración del sistema que se abrirá a continuación, busque y acceda a [Servicios instalados], active el servicio [Heko Remotesupport Input]."),
        ...
        ("Language", "Idioma"),
        ("Keep Heko Remotesupport background service", "Dejar Heko Remotesupport como Servicio en 2do plano"),
        ...
        ("Show Heko Remotesupport", "Mostrar Heko Remotesupport"),
        ("This PC", "Este PC"),
        ("or", "o"),
        ...
        ("config_input", "Para controlar el escritorio remoto con el teclado necesitas dar a Heko Remotesupport permisos de \"Monitorización de entrada\"."),
        ("config_microphone", "Para poder hablar de forma remota necesitas darle a Heko Remotesupport permisos de \"Grabar Audio\"."),
        ...
        ("verify_rustdesk_password_tip", "Verificar la contraseña de Heko Remotesupport"),
