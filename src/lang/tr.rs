...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Kullanıcı Hesabı Denetimi nedeniyle, Heko Remotesupport bir uzak masaüstü olarak düzgün çalışmayabilir. Bu sorunu önlemek için, Heko Remotesupport'i sistem seviyesinde kurmak için aşağıdaki butona tıklayın."),
        ...
        ("Configure", "Ayarla"),
        ("config_acc", "Masaüstünüzü dışarıdan kontrol etmek için Heko Remotesupport'e \"Erişilebilirlik\""),
        ("config_screen", "Masaüstünüzü dışarıdan kontrol etmek için Heko Remotesupport'e \"Ekran Kaydı\" iznini vermeniz gerekir."),
        ...
        ("android_input_permission_tip1", "Uzak bir cihazın Android cihazınızı fare veya dokunma yoluyla kontrol edebilmesi için, Heko Remotesupport'in \"Erişilebilirlik\" özelliğini kullanmasına izin vermelisiniz."),
        ("android_input_permission_tip2", "Sonraki sistem ayarları sayfasına gidin, [Yüklü Hizmetler]'i bulun ve erişin, [Heko Remotesupport Girişi] hizmetini etkinleştirin."),
        ...
        ("Language", "Dil"),
        ("Keep Heko Remotesupport background service", "Heko Remotesupport arka plan hizmetini sürdürün"),
        ...
        ("Show Heko Remotesupport", "Heko Remotesupport'i Göster"),
        ("This PC", "Bu PC"),
        ("or", "veya"),
