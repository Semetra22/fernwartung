...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Opretter forbindelse til Heko Remotesupport-netværket..."),
        ...
        ("install_tip", "På grund af UAC kan Heko Remotesupport ikke fungere korrekt i nogle tilfælde på fjernskrivebordet. For at undgå UAC skal du klikke på knappen nedenfor for at installere Heko Remotesupport på systemet"),
        ...
        ("android_input_permission_tip1", "For at en ekstern enhed kan kontrollere din Android-enhed via mus eller berøring, skal du give Heko Remotesupport mulighed for at bruge tjenesten \"tilgængelighed \"."),
        ("android_input_permission_tip2", "Gå til den næste systemindstillingsside, søg og indtast [installerede tjenester], tænd for [Heko Remotesupport Input] tjenesten."),
        ...
        ("Language", "Sprog"),
        ("Keep Heko Remotesupport background service", "Behold Heko Remotesupport baggrundstjeneste"),
        ...
        ("Show Heko Remotesupport", "Vis Heko Remotesupport"),
        ("This PC", "Denne PC"),
        ("or", "eller"),
