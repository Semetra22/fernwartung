...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "لطفا برنامه را نصب کنید UAC و جلوگیری از خطای Heko Remotesupport برای راحتی در استفاده از نرم افزار"),
        ("Click to upgrade", "برای ارتقا کلیک کنید"),
        ("Click to download", "برای دانلود کلیک کنید"),
        ("Click to update", "برای به روز رسانی کلیک کنید"),
        ("Configure", "تنظیم"),
        ("config_acc", "بدهید \"access\" مجوز Heko Remotesupport برای کنترل از راه دور دسکتاپ باید به"),
        ("config_screen", "بدهید \"screenshot\" مجوز Heko Remotesupport برای کنترل از راه دور دسکتاپ باید به"),
        ...
        ("android_input_permission_tip1", "استفاده کند \"Accessibility\" اجازه دهید از ویژگی Heko Remotesupport شما را از طریق ماوس یا صفحه ی لمسی کنترل کند، باید به Android برای اینکه یک دستگاه از راه دور بتواند دستگاه"),
        ("android_input_permission_tip2", "را پیدا کنید و فعال نمایید \"Heko Remotesupport Input\" بشوید ، سپس گزینه \"Installed Services\" وارد قسمت \"Accessibility\" در صفحه تنظیمات "),
        ...
        ("Language", "زبان"),
        ("Keep Heko Remotesupport background service", "را در پس زمینه نگه دارید Heko Remotesupport سرویس"),
        ...
        ("Show Heko Remotesupport", "Heko Remotesupport نمایش"),
        ("This PC", "This PC"),
        ("or", "یا"),
        ...
        ("config_input", "برای کنترل دسکتاپ از راه دور با صفحه کلید، باید مجوز Heko Remotesupport \"Input Monitoring\" را بدهید."),
        ("config_microphone", "را بدهید. Heko Remotesupport \"Record Audio\" برای صحبت از راه دور، باید مجوز"),
        ...
        ("still_click_uac_tip", "همچنان کاربر از راه دور نیاز دارد که روی OK در پنجره UAC اجرای Heko Remotesupport کلیک کند."),
        ...
        ("install_cert_tip", "Heko Remotesupport نصب گواهی"),
        ("confirm_install_cert_tip", "استفاده خواهد شد Heko Remotesupport است و شما می توانید به این گواهی اعتماد کنید. این گواهی برای اعتماد و نصب درایورهای Heko Remotesupport این گواهینامه یک گواهی تست"),
        ...
        ("verify_rustdesk_password_tip", "رمز عبور Heko Remotesupport را تأیید کنید"),
