...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "就绪"),
        ("Established", "已建立"),
        ("connecting_status", "正在接入 Heko Remotesupport 网络..."),
        ("Enable Service", "允许服务"),
        ("Start Service", "启动服务"),
        ...
        ("Set Password", "设置密码"),
        ("OS Password", "操作系统密码"),
        ("install_tip", "你正在运行未安装版本，由于 UAC 限制，作为被控端，会在某些情况下无法控制鼠标键盘，或者录制屏幕，请点击下面的按钮将 Heko Remotesupport 安装到系统，从而规避上述问题。"),
        ("Click to upgrade", "点击这里升级"),
        ("Click to download", "点击这里下载"),
        ("Click to update", "点击这里更新"),
        ("Configure", "配置"),
        ("config_acc", "为了能够远程控制你的桌面, 请给予 Heko Remotesupport \"辅助功能\" 权限。"),
        ("config_screen", "为了能够远程访问你的桌面, 请给予 Heko Remotesupport \"屏幕录制\" 权限。"),
        ("Installing ...", "安装中..."),
        ("Install", "安装"),
        ("Installation", "安装"),
        ...
        ("android_input_permission_tip1", "为了让远程设备通过鼠标或触屏控制您的安卓设备，你需要允许 Heko Remotesupport 使用\"无障碍\"服务。"),
        ("android_input_permission_tip2", "请在接下来的系统设置页面里，找到并进入 [已安装的服务] 页面，将 [Heko Remotesupport Input] 服务开启。"),
        ...
        ("Language", "语言"),
        ("Keep Heko Remotesupport background service", "保持 Heko Remotesupport 后台服务"),
        ("Ignore Battery Optimizations", "忽略电池优化"),
        ("android_open_battery_optimizations_tip", "如需关闭此功能，请在接下来的 Heko Remotesupport 应用设置页面中，找到并进入 [电源] 页面，取消勾选 [不受限制]"),
        ("Start on Boot", "开机自启动"),
        ...
        ("Show Heko Remotesupport", "显示 Heko Remotesupport"),
        ("This PC", "此电脑"),
        ("or", "或"),
        ("Continue with", "使用"),
        ("Elevate", "提权"),
        ...
        ("config_input", "为了能够通过键盘控制远程桌面, 请给予 Heko Remotesupport \"输入监控\" 权限。"),
        ("config_microphone", "为了支持通过麦克风进行音频传输，请给予 Heko Remotesupport \"录音\"权限。"),
        ...
        ("still_click_uac_tip", "依然需要被控端用户在运行 Heko Remotesupport 的 UAC 窗口点击确认。"),
        ...
        ("install_cert_tip", "安装 Heko Remotesupport 证书"),
        ("confirm_install_cert_tip", "此证书为 Heko Remotesupport 测试证书，您可以信任此证书。证书将被用于信任和安装 Heko Remotesupport 驱动。"),
        ("RDP Settings", "RDP 设置"),
        ("Sort by", "排序方式"),
        ("New Connection", "新连接"),
        ("Restore", "恢复"),
        ...
        ("verify_rustdesk_password_tip", "验证 Heko Remotesupport 密码"),
