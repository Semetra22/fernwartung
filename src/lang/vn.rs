...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Đang kết nối đến mạng lưới Heko Remotesupport..."),
        ...
        ("install_tip", "Do UAC, Heko Remotesupport sẽ không thể hoạt động đúng cách là bên từ xa trong vài trường hợp. Để tránh UAC, hãy nhấn cái nút dưới đây để cài Heko Remotesupport vào hệ thống."),
        ("Click to upgrade", "Nhấn để nâng cấp"),
        ("Click to download", "Nhấn để tải xuống"),
        ("Click to update", "Nhấn để cập nhật"),
        ("Configure", "Cài đặt"),
        ("config_acc", "Để có thể điều khiển máy tính từ xa, bạn cần phải cung cấp quyền \"Trợ năng\" cho Heko Remotesupport"),
        ("config_screen", "Để có thể truy cập máy tính từ xa, bạn cần phải cung cấp quyền \"Ghi Màn Hình\" cho Heko Remotesupport."),
        ("Installing ...", "Đang cài ..."),
        ("Install", "Cài"),
        ("Installation", "Cài"),
        ...
        ("android_input_permission_tip1", "Để thiết bị từ xa điều khiển thiết bị Android của bạn bằng chuột hoặc chạm, bạn cần cho phép Heko Remotesupport sử dụng dịch vụ \"Trợ năng\"."),
        ("android_input_permission_tip2", "Vui lòng chuyển đến trang cài đặt hệ thống tiếp theo, tìm và nhập [Dịch vụ đã cài đặt], bật dịch vụ [Heko Remotesupport Input]."),
        ...
        ("Language", "Ngôn ngữ"),
        ("Keep Heko Remotesupport background service", "Giữ dịch vụ nền Heko Remotesupport"),
        ("Ignore Battery Optimizations", "Bỏ qua các tối ưu pin"),
        ("android_open_battery_optimizations_tip", "Nếu bạn muốn tắt tính năng này, vui lòng chuyển đến trang cài đặt ứng dụng Heko Remotesupport tiếp theo, tìm và nhập [Pin], Bỏ chọn [Không hạn chế]"),
        ...
        ("Show Heko Remotesupport", "Hiện Heko Remotesupport"),
        ("This PC", ""),
        ("or", "hoặc"),
        ...
        ("config_input", "Để điều khiển được máy tính từ xa với bàn phím, bạn cần cho phép Heko Remotesupport quyền \"Theo dõi đầu vào\" (Input Monitoring)"),
        ("config_microphone", "Để nói chuyện từ xa, bạn phải cho phép Heko Remotesupport quyền \"Ghi âm thanh\" (Record Audio)"),
        ...
        ("still_click_uac_tip", "Vẫn cần người dùng từ xa nhấn OK trên cửa sổ UAC của Heko Remotesupport đang chạy."),
        ...
        ("verify_rustdesk_password_tip", "Xác thực mật khẩu Heko Remotesupport"),
