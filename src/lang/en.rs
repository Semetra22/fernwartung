...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the Heko Remotesupport network..."),
        ...
        ("install_tip", "Due to UAC, Heko Remotesupport can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install Heko Remotesupport to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant Heko Remotesupport \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant Heko Remotesupport \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow Heko Remotesupport to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [Heko Remotesupport Input] service."),
        ...
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next Heko Remotesupport application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant Heko Remotesupport \"Input Monitoring\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running Heko Remotesupport."),
        ("config_microphone", "In order to speak remotely, you need to grant Heko Remotesupport \"Record Audio\" permissions."),
        ...
        ("install_cert_tip", "Install Heko Remotesupport certificate"),
        ("confirm_install_cert_tip", "This is a Heko Remotesupport testing certificate, which can be trusted. The certificate will be used to trust and install Heko Remotesupport drivers when required."),
        ...
        ("enter_rustdesk_passwd_tip", "Enter Heko Remotesupport password"),
        ("remember_rustdesk_passwd_tip", "Remember Heko Remotesupport password"),
        ("login_linux_tip", "You need to login to remote Linux account to enable a X desktop session"),
        ("verify_rustdesk_password_tip", "Verify Heko Remotesupport password"),
